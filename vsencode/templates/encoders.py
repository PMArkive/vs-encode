...
--preset placebo --crf 14 --deblock -1:-1 --min-keyint {min_keyint:d} --keyint {keyint:d} --ref 6 --bframes 8
--aq-mode 3 --aq-strength 0.70 --qcomp 0.80 --rc-lookahead {keyint:d}
...
--preset slow --crf 15 --deblock=-2:-2 --min-keyint {min_keyint:d} --keyint {keyint:d} --ref 5 --bframes 8
--aq-mode 3 --aq-strength 0.70 --qcomp 0.80 --cbqpoffs -2 --crqpoffs -2 --rc-lookahead {keyint:d}
